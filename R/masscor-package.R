...
#'
#' @section Disclaimer:
#' The Instituto Nacional de Metrologia de Colombia (INM) has published this package to ease some calculations
#' involved in mass metrology applications. We endeavor to update it on a regular basis, but cannot guarantee
#' the accuracy of all implemented methods. Any reference to commercial measurement instruments does not imply any approval,
