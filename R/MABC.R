...
#' due to their buoyancy in air. This air buoyancy effects can be corrected considering the objects
#' densities and that of the air in the room where the measurement process takes place (Harris, 2019).
#'
